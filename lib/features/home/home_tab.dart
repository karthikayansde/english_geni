        ...
        return SafeArea(
          ...
          child: CustomScrollView(
            ...
            slivers: [
                  ...
                  child: Stack(
                    ...
                    children: [
                      ...
                      Column(
                        children: [
                          Text(
                            "Hello, ${AppTheme.instance.storage.read<String>('user_name') ?? 'Sandra'}",
              ...
              SliverPadding(
                padding: const EdgeInsets.symmetric(horizontal: AppDimensions.scaffoldPaddingHorizontal, vertical: AppDimensions.lg,),
                sliver: SliverToBoxAdapter(
                  child: SizedBox(
                    height: 70,
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: _weekDays.indexed.map((e) => AnimatedContainer(
                        width: 42,
                    ...
                    children: [
                      Expanded(
                        child: Container(
                          ...
                          padding: const EdgeInsets.all(20),
                          decoration: BoxDecoration(
                            color: theme.extension<AppColorsExtension>()?.featureOrange ?? colors.secondaryContainer,
                        ...
                        child: Column(
                          children: [
                            Container(
                              ...
                              decoration: BoxDecoration(
                                color: theme.extension<AppColorsExtension>()?.featureBlue ?? colors.primaryContainer,
                                borderRadius: BorderRadius.circular(24),
                              ),
                              child: Align(
                                alignment: Alignment.bottomLeft,
                            ...
                            Container(
                              ...
                              width: double.infinity,
                              decoration: BoxDecoration(
                                color: theme.extension<AppColorsExtension>()?.featurePink ?? colors.tertiaryContainer,
                                borderRadius: BorderRadius.circular(24),
                              ),
                              child: Center(
                                child: Row(
                                  ...
                                  children: [
                                    Icon(Icons.star_rounded, color: colors.onSurface, size: 20),
                                    const SizedBox(width: 8),
                                    Icon(Icons.favorite_rounded, color: colors.onSurface, size: 20),
                                  ],
                                ),
                              ),
                            ),
